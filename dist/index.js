    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    json = _b.sent();
                    if (!isDanfe) return [3 /*break*/, 3];
                    return [4 /*yield*/, new json_to_danfe_use_case_1.JsonToDanfe().jsonToPDF(json)];
                case 2:
                    _a = _b.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, new json_to_cte_use_case_1.JsonToCTE().jsonToPDF(json)];
                case 4:
                    _a = _b.sent();
                    _b.label = 5;
                case 5:
