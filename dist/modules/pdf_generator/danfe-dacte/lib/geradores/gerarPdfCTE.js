...
var diretorioDeFontes = node_path_1.default.join(__dirname, "./fontes");
var timesNewRoman = node_path_1.default.join(diretorioDeFontes, "Times New Roman.ttf");
var timesNewRomanNegrito = node_path_1.default.join(diretorioDeFontes, "Times New Roman Bold.ttf");
var timesNewRomanItalico = node_path_1.default.join(diretorioDeFontes, "Times New Roman Italic.ttf");
var timesNewRomanNegritoItalico = node_path_1.default.join(diretorioDeFontes, "Times New Roman Bold Italic.ttf");
var barcode = node_path_1.default.join(diretorioDeFontes, "code128.ttf");
var pdfDefaults = {
    ajusteY: 0,
    ajusteX: 0,
    autor: "",
...
exports.default = (function (dacte, args, callback) {
    ...
    args = __assign(__assign({}, pdfDefaults), args);
    var emitente = dacte.getEmitente();
    var destinatario = dacte.getDestinatario();
    var transportador = dacte.getTransportador();
    var impostos = dacte.getImpostos();
    var protocolo = dacte.getProtocolo();
    var itens = dacte.getItens();
    var expeditor = dacte.getExpeditor();
    var recebedor = dacte.getRecebedor();
    ...
    function desenharPagina() {
        ...
        titulo("DADOS ESPECÍFICOS DO MODAL RODOVIÁRIO - CARGA FRACIONADA", 160, 746, 300);
        ...
        titulo("ESTE CONHECIMENTO DE TRANSPORTE ATENDE À LEGISLAÇÃO DE TRANSPORTE RODOVIÁRIO EM VIGOR", 291, 756, 250, "center", 6);
        ...
        if (emitente.getInscricaoEstadual()) {
            infoEmitente =
                infoEmitente + "  Insc.Estadual: " + emitente.getInscricaoEstadual();
        }
        if (infoEmitente !== "") {
        ...
        normal("Documento Auxiliar do Conhecimento de Transporte Eletrônico", 270, 72, 135, "center");
        ...
        campo(transportador.getEndereco().getPrimeiraLinha(), 40, 251, 280, "left", 6);
        campo(transportador.getEndereco().getMunicipio(), 40, 261, 120, "left", 7);
        campo(transportador.getRegistroNacionalFormatado(), 40, 271, 120, "left", 7);
        ...
        campo(destinatario.getEndereco().getPrimeiraLinha(), 321, 251, 280, "left", 6);
        campo(destinatario.getEndereco().getMunicipio(), 321, 261, 120, "left", 7);
        campo(destinatario.getRegistroNacionalFormatado(), 321, 271, 120, "left", 7);
        ...
        campo(expeditor.getEndereco().getPrimeiraLinha(), 40, 302, 280, "left", 6);
        campo(expeditor.getEndereco().getMunicipio(), 40, 312, 120, "left", 7);
        campo(expeditor.getRegistroNacionalFormatado(), 40, 322, 280, "left", 6);
        ...
        campo(recebedor.getEndereco().getPrimeiraLinha(), 321, 302, 120, "left", 7);
        campo(recebedor.getEndereco().getMunicipio(), 321, 312, 120, "left", 7);
        campo(recebedor.getRegistroNacionalFormatado(), 321, 322, 120, "left", 7);
        ...
        if (tomador !== "") {
            ...
            campo(tomador.getEndereco().getPrimeiraLinha(), 80, 352, 200, "left", 7);
            campo(tomador.getRegistroNacionalFormatado(), 80, 362, 200, "left", 7);
            campo(tomador.getInscricaoEstadual(), 380, 362, 200, "left", 7);
            campo(tomador.getEndereco().getMunicipio(), 360, 342, 200, "left", 7);
        ...
        var xMedida = -58, yMedida = 404, medidas = cteInfo.getMedidas();
        if (medidas && Array.isArray(medidas)) {
            medidas.map(function (medida) {
                xMedida += 60;
                if (xMedida > 122) {
                    xMedida = 2;
                    yMedida = 416;
                }
                return campo(String(medida.qCarga._text +
                    " / " +
                    cteInfo.retornaUnidadeMedida(medida.cUnid._text)), xMedida, yMedida, 60, "left", 8);
            });
        }
        else if (medidas) {
            campo(String(medidas.qCarga._text +
                " / " +
                cteInfo.retornaUnidadeMedida(medidas.cUnid._text)), 1, 408, 30, "left", 8);
        }
        ...
        titulo("COMPONENTES DO VALOR DA PRESTAÇÃO DO SERVIÇO", 195, 426, 300, "left", 7);
        var componenteServico = cteInfo.getComponenteServico(), xComponente = 1, yComponente = 436;
...
//# sourceMappingURL=gerarPdfCTE.js.map