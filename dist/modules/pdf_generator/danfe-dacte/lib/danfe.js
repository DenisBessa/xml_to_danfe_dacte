...
var Danfe = /** @class */ (function () {
    function Danfe() {
        this.comOrientacao("retrato");
        this.comEmitente(new emitente_1.default());
        this.comDestinatario(new destinatario_1.default());
        this.comTransportador(new transportador_1.default());
        this.comProtocolo(new protocolo_1.default());
        this.comImpostos(new impostos_1.default());
        this.comVolumes(new volumes_1.default());
        this.comExpeditor(new expeditor_1.default());
        this.comRecebedor(new recebedor_1.default());
        this.comCteInfo(new cteInfo_1.default());
        this._itens = [];
    }
    ...
    Danfe.prototype.getNumeroFormatado = function () {
        // if(this.getNumero()) {
        // }
        return "N\u00BA. ".concat(this.getNumero());
    };
    Danfe.prototype.comNumero = function (_numero) {
        _numero = Number.parseInt(_numero, 10);
        if (Number.isNaN(_numero)) {
            throw new Error("N\u00E3o \u00E9 um n\u00FAmero v\u00E1lido. Valor encontrado: ".concat(_numero));
        }
    ...
    Danfe.prototype.getSerieFormatada = function () {
        // if(this.getSerie()) {
        // }
        return "S\u00C9RIE ".concat(this.getSerie());
    };
...
exports.default = Danfe;
//# sourceMappingURL=danfe.js.map